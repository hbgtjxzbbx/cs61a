...
def add_song(t, song, category):
    ...
    "*** YOUR CODE HERE ***"
    if root(t)==category:
        #allbranches=branches(t).append(tree(song)) why this line code didn't work
        allbranches=branches(t)
        allbranches.append(tree(song))
        return tree(root(t),allbranches)
